			...
			<footer id="footer_content">
				...
				<script defer src="https://kit.fontawesome.com/d858406368.js" crossorigin="anonymous"></script>
				...
				<!-- Global site tag (gtag.js) - Google Ads: 454880969 -->
				<script src="https://www.googletagmanager.com/gtag/js?id=AW-454880969"></script>
				<script>
				  window.dataLayer = window.dataLayer || [];
				  function gtag(){dataLayer.push(arguments);}
				  gtag('js', new Date());

				  gtag('config', 'AW-454880969');
				</script>

			
				<!-- google analytics -->
				<script src="https://www.googletagmanager.com/gtag/js?id=G-8Q5QEY7191"></script>
				<script>
				  window.dataLayer = window.dataLayer || [];
				  function gtag(){dataLayer.push(arguments);}
				  gtag('js', new Date());

				  gtag('config', 'G-8Q5QEY7191');
				</script>
				
				<!-- start number replacer -->
				<script type="text/javascript"><!--
				vs_account_id   = "fwABAV1KIJR4fABn";
				//--></script>
				<script  defer type="text/javascript" src="https://rw1.calls.net/euinc/number-changer.js ">
				</script>
				<!-- end ad widget -->
