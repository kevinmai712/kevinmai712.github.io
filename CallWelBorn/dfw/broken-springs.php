...
<section id="service_content">
	<div class="container">
		...
		<div id="service_content_description">
			...
			<?php include "includes/service_icon.inc.php" ; ?>
		</div>
		<div id="service_content_footer">
			<p>Have another problem not listed here? We can still help diagnose your problem and get it fixed for you!</p>
		</div>
	</div>
</section>
